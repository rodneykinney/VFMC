...
class TestSkeleton(unittest.TestCase):
    def test_normalize(self):
        self.assertEqual(["U2", "F2"], normalize("U D R2 U D'".split(" "), is_minimal_htr_section,
                                                 CORNER_INVARIANT))
        self.assertEqual(["F2"], normalize("F2 L2 F2 R2".split(" "), is_minimal_htr_section,
                                           CORNER_INVARIANT))
    ...
    def test_qt_positions(self):
        ...
        self.assertEqual((0, 7, 9, 11, 13),
                         DrSolution("D B2 D' R2 L2 U L2 D' R2 U R2 D' F2 U' B2").qt_positions)
        self.assertEqual((0,),
                         DrSolution("U R2 U D R2").qt_positions)
        self.assertEqual((0, 2, 8, 10, 13),
                         DrSolution("U' F2 U F2 L2 U D F2 U L2 U' F2 L2 U L2").qt_positions)
    ...
    def test_htr_sections(self):
        ...
        self.assertEqual([[], ["B2", "D'", "R2", "L2", "U", "L2"], ["R2"], ["R2"], ["F2"], ["B2"]],
                         DrSolution("D B2 D' R2 L2 U L2 D' R2 U R2 D' F2 U' B2").htr_sections)
        self.assertEqual([[], ["R2", "U", "D", "R2"], []],
                         DrSolution("U R2 U D R2 U").htr_sections)
        self.assertEqual([[], ["F2"], ["F2", "L2", "U", "D", "F2"], []],
                         DrSolution("U' F2 U F2 L2 U D F2 U").htr_sections)

    def test_leave_slice(self):
        self.assertEquals("U2 F2 B2 U' F2 L2 F2 R2 D' F2 D2 R2 F2 R2 B2", DrSolution("U D R2 U D' B2 U' F2 L2 F2 R2 D' F2 D2 R2 F2 R2 B2").leave_slice.alg)
    ...
    def test_corner_skeleton(self):
        ...
        self.assertEqual("U R2 U R2 U2 F2", DrSolution("U D R2 U D' B2 U' F2 L2 F2 R2 D' F2 D2 R2 F2 R2 B2").corner_skeleton.alg)
        self.assertEqual("U F2 U F2 U' F2 U F2 U F2", DrSolution("D B2 D' R2 L2 U L2 D' R2 U R2 D' F2 U' B2").corner_skeleton.alg)
        self.assertEqual("U R2 U2 F2", DrSolution("U R2 U D R2").corner_skeleton.alg)
        ...
        self.assertEqual("U' F2 U' F2 U R2 U2", DrSolution("D R2 D2 R2 F2 B2 U R2 U B2 L2 B2 L2 D2").corner_skeleton.alg)
