...
class TestSkeleton(unittest.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(["R2 F2 R2", "U2 R2", "F2 U2 F2 R2"], [p.alg for p in DrAlgorithm.parse("R2 F2 R2 U' R2 U F2 U2 F2 R2").parts])
        self.assertEqual(["", "B2 D' R2 L2 U L2", "U2 R2", "R2", "U2 F2", "U2 B2"], [p.alg for p in DrAlgorithm.parse("D B2 D' R2 L2 U L2 D' R2 U R2 D' F2 U' B2").parts])
    ...
    def test_dr_solution_breakdown(self):
        ...
        self.assertEqual("F2 Fw2 Uw Fw2 U R2", sol.normalized_alg)

        sol = DrSolutionBreakdown.parse("U R2 U F2 B2 U F2 U F2")
        self.assertEqual("U R2 U F2 Fw2 Uw Rw2 U Rw2", sol.normalized_alg)
